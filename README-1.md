...
- **Qiymət tarixçəsi (icma):** İstifadəçilərin daxil etdiyi "indiki bazar
  qiyməti" dəyərləri artıq anonim şəkildə (heç bir istifadəçi ID-si
  saxlanmadan) toplanır. "İndiki bazar qiyməti neçədir?" sualı veriləndə,
  əgər kifayət qədər məlumat varsa, botun özü son bildirilən qiyməti,
  24 saatlıq ortanı və 7 günlük tendensiyanı (📈/📉/➡️) göstərir. İstənilən
  vaxt `/qiymetler` əmri (və ya "📈 Qiymətlər" düyməsi) ilə bütün 4 resursun
  icma qiymətlərinə baxıla bilər.
...
- `price_history.py` - icma qiymət tarixçəsi (anonim, bot_data-da saxlanır)
